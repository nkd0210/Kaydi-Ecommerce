        ...
        <div>
            ...
            <Navbar />
            {
                loadingOrder ? (
                    ...
                    <div className='p-[20px] max-md:p-[10px] w-full gap-[20px] h-[600px] overflow-y-scroll max-md:h-full'>
                        <h1 className='text-[20px] uppercase font-semibold my-[20px]'>Đánh giá sản phẩm</h1>
                        {
                            loadingReview ? (
                                <Loader />
                            ) : (
                                <form onSubmit={handleSubmitFormReview} className=' border rounded-[10px] shadow-md p-[20px] h-[600px] max-md:h-full overflow-y-scroll max-md:p-[10px] flex max-md:flex-col gap-[40px] '>
                                    {/* products */}
                                    ...
                                    {/* review */}
                                    <div className='border rounded-[10px] h-[800px] max-md:h-full  w-full p-[20px] max-md:p-[10px] flex flex-col gap-[20px] animate__animated animate__fadeInRight '>
